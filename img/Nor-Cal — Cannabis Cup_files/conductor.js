...
(function ( window, document, $, undefined ) {
  ...
  var conductor = {
    ...
    findAndInitScenes: function() {
      ...
      //   app.log("Scene progress changed to " + event.progress);
      // });
  ...
  window.app.controllers.conductor = conductor;
  ...
  $('.event-navigation').on("click", "h1", function(e) {
